...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-PNImagePickerViewController_Tests/Expecta_Snapshots.framework"
  install_framework "Pods-PNImagePickerViewController_Tests/FBSnapshotTestCase.framework"
